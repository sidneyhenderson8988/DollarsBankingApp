...
public class ConsolePrinterUtility {
	...
	public int welcomeCustLogic() {
		...
		case 2:
			...
			else {System.out.println("Operation Failed: Not enough funds to withdraw amount");}
		...
		case 3:
			...
			else {System.out.println("Operation Failed: Not enough funds to transfer amount");}
			...
			getLoggedAccount().getTransactions().add("\nTransfered $" + transAmount + " from savings to " + getTransAccount().getC1().getUserID() + " at " + myTime3 );
			break;
		case 4:
			
			System.out.println(getLoggedAccount().getTransactions());
			break;
		case 5:
